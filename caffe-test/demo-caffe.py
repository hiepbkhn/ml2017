...
caffe_root = 'F:/caidat/Machine Learning/caffe-cuda8-python35/'
...
print ('mean-subtracted values:' + repr(zip('BGR', mu)))
...
print ('predicted class is:' + repr(output_prob.argmax()))
...
print ('output label:' + repr(labels[output_prob.argmax()]))
