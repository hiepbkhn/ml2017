...
def main():
    ...
    if args.do_train and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
        ...
        model = DebertaV2ForQuestionAnswering.from_pretrained(args.output_dir)  # , force_download=True)
    ...
    if args.do_eval and args.local_rank in [-1, 0]:
        ...
        for checkpoint in checkpoints:
            ...
            model = DebertaV2ForQuestionAnswering.from_pretrained(checkpoint)  # , force_download=True)
            model.to(args.device)
