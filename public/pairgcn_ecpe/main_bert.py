...
import numpy as np
import random
from utils.data_loader_bert import CausePairLoader
from wrapper_bert import Wrapper
import warnings
...
parser.add_argument('--hidden_dim', type=int, default=200, help='LSTM hidden dim.')
