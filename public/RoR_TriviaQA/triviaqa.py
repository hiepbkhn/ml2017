...
from transformers import RobertaTokenizer, AutoModel, AutoConfig, AutoModelWithLMHead, LongformerModel
...
class TriviaQA(pl.LightningModule):
    ...
    def decode(self, input_ids, start_logits, end_logits, ids=None):
...
def main(args):
    ...
    trainer = pl.Trainer(gpus=[0], distributed_backend='ddp' if args.gpus and args.gpus > 1 else None,
