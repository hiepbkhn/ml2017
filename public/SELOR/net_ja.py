...
from transformers import BertModel, BertTokenizer, BertConfig, BertJapaneseTokenizer
...
def get_tf_model(
    ...
    if base == 'bert':
        pre_trained_model_name = 'cl-tohoku/bert-base-japanese-v2'
        tf_tokenizer = BertJapaneseTokenizer.from_pretrained(pre_trained_model_name)
